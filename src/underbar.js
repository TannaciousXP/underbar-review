(function() {
  ...
  _.last = function(array, n) {
    return n === undefined ? array.pop() : array.slice(Math.max(0, array.length - n));
  };
  ...
  _.uniq = function(array) {
    var obj = {};
    return _.reduce(array, function(arr, ele) {
      if (!obj[ele]) {
        obj[ele] = true;
        arr.push(ele);
      }
  ...
  _.map = function(collection, iterator) {
    ...
    return _.reduce(collection, function(newArr, item) {
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    _.each(collection, function(item, idx, collection) {
      if (hasNoAccum) {
        ...
        accumulator = iterator(accumulator, item, idx, collection);
      }
    });
    return accumulator;
  };
  ...
  _.some = function(collection, iterator) {
    ...
    var test = iterator || _.identity;
    return _.reduce(collection, function(somePassed, item) {
      return somePassed || !!test(item);
    }, false);
  };
